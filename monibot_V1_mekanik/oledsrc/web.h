    ...
    <table>
        ...
        <tr>
            <td colspan="4" align="center">
                <button class="button servo" onmousedown="toggleCheckbox('servo_up'); animateButton(this);" ontouchstart="toggleCheckbox('servo_up'); animateButton(this);">Atas</button>

                <button class="button servo" onmousedown="toggleCheckbox('servo_left'); animateButton(this);" ontouchstart="toggleCheckbox('servo_left'); animateButton(this);">Kiri</button>

                <button class="button servo" onmousedown="toggleCheckbox('servo_right'); animateButton(this);" ontouchstart="toggleCheckbox('servo_right'); animateButton(this);">Kanan</button>

                <button class="button servo" onmousedown="toggleCheckbox('servo_down'); animateButton(this);" ontouchstart="toggleCheckbox('servo_down'); animateButton(this);">Bawah</button>
            </td>
        </tr>
